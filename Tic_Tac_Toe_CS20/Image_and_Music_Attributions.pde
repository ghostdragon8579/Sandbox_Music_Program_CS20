void ImageMusicAttributions () {
  ...
  textFont(TitleFont, FontSizes2[5]);
  text(MusicPlayerText[4], xIconAttribution, yIconAttribution, TextDIVWidth[4], TextDIVHeight[4]);
  text(MusicPlayerText[5], xBackgroundAttribution, yBackgroundAttribution, TextDIVWidth[5], TextDIVHeight[5]);
  //Song Attributions
  text(MusicPlayerText[6], xSongAttribution1, ySongAttribution1, TextDIVWidth[6], TextDIVHeight[6]);
  text(MusicPlayerText[7], xSongAttribution2, ySongAttribution2, TextDIVWidth[7], TextDIVHeight[7]);
  text(MusicPlayerText[8], xSongAttribution3, ySongAttribution3, TextDIVWidth[8], TextDIVHeight[8]);
  text(MusicPlayerText[9], xSongAttribution4, ySongAttribution4, TextDIVWidth[9], TextDIVHeight[9]);
  text(MusicPlayerText[10], xSongAttribution5, ySongAttribution5, TextDIVWidth[10], TextDIVHeight[10]);
  text(MusicPlayerText[11], xSongAttribution6, ySongAttribution6, TextDIVWidth[11], TextDIVHeight[11]);
  text(MusicPlayerText[12], xSongAttribution1Line2, ySongAttribution1Line2, TextDIVWidth[12], TextDIVHeight[12]);
  text(MusicPlayerText[13], xSongAttribution2Line2, ySongAttribution2Line2, TextDIVWidth[13], TextDIVHeight[13]);
  text(MusicPlayerText[14], xSongAttribution3Line2, ySongAttribution3Line2, TextDIVWidth[14], TextDIVHeight[14]);
  text(MusicPlayerText[15], xSongAttribution4Line2, ySongAttribution4Line2, TextDIVWidth[15], TextDIVHeight[15]);
  text(MusicPlayerText[16], xSongAttribution5Line2, ySongAttribution5Line2, TextDIVWidth[16], TextDIVHeight[16]);
  text(MusicPlayerText[17], xSongAttribution6Line2, ySongAttribution6Line2, TextDIVWidth[17], TextDIVHeight[17]);
