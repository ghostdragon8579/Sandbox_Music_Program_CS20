...
void MusicPlayerVoidSetup() {
  ...
  //
  //Music Pathway
  String RelativeMusicPathway = "/Tic_Tac_Toe_CS20_Audio_Files/";
...
void MusicPlayerVoidDraw() {
  ...
  textFont(TitleFont, FontSizes2[0]);
  text(MusicPlayerText[0], xMusicTitle, yMusicTitle, TextDIVWidth[0], TextDIVHeight[0]);
  textFont(TitleFont, FontSizes2[1]);
  text(MusicPlayerText[1], xMusicAuthor, yMusicAuthor, TextDIVWidth[1], TextDIVHeight[1]);
  textFont(TitleFont, FontSizes2[1]);
  text(MusicPlayerText[2], xMusicPublishDate, yMusicPublishDate, TextDIVWidth[2], TextDIVHeight[2]);
  fill(resetDefaultInk);
  }
  //
  //Attributions
  ...
  textAlign(CENTER, CENTER);
  textFont(TitleFont, FontSizes2[3]);
  fill(TextPurple);
  text(MusicPlayerText[3], xAttributions, yAttributions, TextDIVWidth[3], TextDIVHeight[3]);
  //
  if (Attributions) {
...
void MusicPlayerMousePressed() {
  ...
  if (MouseIsOver(xMusicProgressBar, yMusicProgressBar, widthMusicProgressBar, heightMusicProgressBar)) {
    float ProgressBarPositionClicked = mouseX-xMusicProgressBar*19/20;
